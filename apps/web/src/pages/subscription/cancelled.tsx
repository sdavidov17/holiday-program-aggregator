        ...
        <div className="container flex flex-col items-center justify-center gap-6 px-4 py-16">
          ...
          >
            ...
            <p className="text-md text-gray-400 mb-8">
              We&apos;d love to have you join us! Our annual subscription gives you access to all
              premium features and helps you find the perfect holiday programs for your children.
            </p>
