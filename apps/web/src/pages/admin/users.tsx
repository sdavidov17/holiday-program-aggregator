          ...
          {stats && (
            <div style={{
              ...
              <div style={{
                ...
                <p style={{ margin: 0, fontSize: "24px", fontWeight: "bold" }}>{stats.totalUsers}</p>
              </div>
              <div style={{
                padding: "20px",
                ...
                <h3 style={{ margin: "0 0 10px 0", color: "#666", fontSize: "14px" }}>Admin Users</h3>
                <p style={{ margin: 0, fontSize: "24px", fontWeight: "bold" }}>{stats.adminUsers}</p>
              </div>
              <div style={{
                padding: "20px",
                ...
                <h3 style={{ margin: "0 0 10px 0", color: "#666", fontSize: "14px" }}>Verified Users</h3>
                <p style={{ margin: 0, fontSize: "24px", fontWeight: "bold" }}>{stats.verifiedUsers}</p>
              </div>
              <div style={{
                padding: "20px",
                ...
                <h3 style={{ margin: "0 0 10px 0", color: "#666", fontSize: "14px" }}>New (30 days)</h3>
                <p style={{ margin: 0, fontSize: "24px", fontWeight: "bold" }}>{stats.recentUsers}</p>
              </div>
            </div>
          )}
