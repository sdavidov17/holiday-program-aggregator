        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className={`text-3xl font-bold ${
                metrics.cronStatus === 'success' ? 'text-green-600' : 
                metrics.cronStatus === 'failed' ? 'text-red-600' : 'text-gray-600'
              }`}>
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-md">
            <p className="text-sm text-yellow-800">
              <strong>Note:</strong> This is a demo monitoring dashboard with mock data. 
              In production, this would connect to real monitoring services like Datadog, New Relic, or CloudWatch.
            </p>
          </div>
        </div>
      </main>
